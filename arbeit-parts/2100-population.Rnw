...
\begin{align*}
  \bar{y} = \frac{1}{n} \sumin y_i = \Sexpr{population_total_table_mean_population}
\end{align*}

\begin{align*}
  s_x = \sqrt{\sumin (x_i - \bar{x})^2}
\end{align*}

\begin{align*}
  s_y = \sqrt{\sumin (y_i - \bar{y})^2}
\end{align*}

\begin{align*}
  s_{xy} = \sumin (x_i - \bar{x})(y_i - \bar{y})
\end{align*}
