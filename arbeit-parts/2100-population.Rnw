...
Das Wachstum der Weltbevölkerung lässt sich grafisch folgendermassen darstellen:

<<echo=FALSE,fig.height=4>>=
source('./2110-population-total.R')

qplot(year, population, data = ppsum, geom = 'line') + scale_y_continuous(label = f, lim = c(0, 8000000000)) + labs(y = 'Weltbevölkerung', x = 'Jahr')
@
