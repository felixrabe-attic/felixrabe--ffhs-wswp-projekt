...
ggplot(ppsum, aes(year, population)) + geom_line() + geom_smooth(method = 'lm') + scale_y_continuous(label = f, lim = c(0, 8000000000)) + labs(y = 'Weltbevölkerung', x = 'Jahr')
@

\newpage

Im betrachteten Zeitraum, besonders ab 1980 ist ein ungefähr lineares Wachstum erkennbar. Eine Suche auf Google zeigt den breiteren Kontext:
