...
ggplot(ppsum, aes(year, population, color = type)) + geom_line() + scale_y_continuous(label = f, lim = c(0, 8000000000)) + labs(y = 'Weltbevölkerung', x = 'Jahr')
@

Im betrachteten Zeitraum ist ein ungefähr lineares Wachstum erkennbar. Eine Suche auf Google zeigt den breiteren Kontext:
