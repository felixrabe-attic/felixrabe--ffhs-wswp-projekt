...
Im betrachteten Zeitraum, besonders ab 1980 ist ein ungefähr lineares Wachstum erkennbar. Mit der ``Methode der kleinsten Quadrate'' lässt sich die verwendete Regressionsgerade herleiten:
...
Eine Suche auf Google zeigt das Wachstum in einem längeren Zeitraum:
