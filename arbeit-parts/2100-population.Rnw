...
Im betrachteten Zeitraum, besonders ab 1980 ist ein ungefähr lineares Wachstum erkennbar. Folgendermassen lässt sich die verwendete Regressionsgerade herleiten:
...
Eine Suche auf Google zeigt das Wachstum in einem grösseren Zeitraum:
