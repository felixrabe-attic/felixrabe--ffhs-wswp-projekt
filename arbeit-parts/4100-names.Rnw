...
\begin{align*}
  ...
  P(A) &\defeq \text{Jemand heisst ``Smith''} \\
  P(A|B) &\defeq \text{Jemand heisst ``Smith'' unter der Voraussetzung, dass er Amerikaner ist} \\
  P(B) &\defeq \text{Jemand ist Amerikaner} \\
  P(A \cap B) &\defeq \text{Jemand heisst ``Smith'' und ist Amerikaner}
\end{align*}
